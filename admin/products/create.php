        ...
        <div style="display: flex; flex-direction: column; gap: 24px;">
            <div class="adm-card" style="padding: 24px;">
                ...
                <div class="form-group" style="margin-bottom: 16px;">
                    ...
                    <input type="text" name="name" class="form-control" required placeholder="VD: Sofa Loveseat">
                </div>

                <div class="form-group" style="margin-bottom: 16px;">
                    <label class="form-label">Mô tả sản phẩm</label>
                    <textarea name="description" class="form-control" rows="5" placeholder="Nhập mô tả chi tiết sản phẩm..."></textarea>
                </div>
            </div>
            ...
            <div class="adm-card" style="padding: 24px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px; margin-bottom: 16px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="sale_price" class="form-control" min="0" placeholder="0 (Để trống nếu ko giảm)">
                    </div>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                    <div class="form-group">
                        ...
                        <input type="text" name="sku" class="form-control" placeholder="VD: SOFA-001">
                    </div>
                    <div class="form-group">
            ...
            <div class="adm-card" style="padding: 24px;">
                ...
                <div class="form-group">
                    <div id="image-preview" style="display: none; margin-bottom: 16px;">
                        ...
                        <p style="text-align:center; font-size: 12px; color: var(--gray-400); margin-top: 8px;">Ảnh xem trước</p>
                    </div>
                    <div style="border: 2px dashed var(--gray-300); border-radius: 8px; padding: 24px; text-align: center; background: var(--gray-100);">
                        ...
                        <div style="font-size: 12px; color: var(--gray-400); margin-bottom: 12px;">Chọn ảnh để tải lên</div>
                        <input type="file" name="thumbnail" id="thumbnail-input" accept="image/*" class="form-control" style="background: white; font-size: 13px;">
                    </div>
                </div>
            </div>

            <button type="submit" class="btn btn-dark" style="width: 100%; padding: 14px;"><i class="fa-solid fa-check"></i> Lưu Sản Phẩm</button>
        </div>
